...
class MakeCreate(LoginRequiredMixin, CreateView):
    model = Make #Searches for autos/make_form.html
    fields = '__all__'
...
class MakeDelete(LoginRequiredMixin, DeleteView):
    model = Make #Searches for autos/make_confirm_delete.html
    fields = '__all__'
    success_url = reverse_lazy('autos:all')
...
class AutoCreate(LoginRequiredMixin, CreateView):
    model = Auto #Searches for autos/auto_form.html
    fields = '__all__'
    success_url = reverse_lazy('autos:all')
...
class AutoDelete(LoginRequiredMixin, DeleteView):
    model = Auto  #Searches for autos/auto_confirm_delete.html
    fields = '__all__'
    success_url = reverse_lazy('autos:all')
